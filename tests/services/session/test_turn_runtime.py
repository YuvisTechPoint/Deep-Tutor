...
class TestExtractTemporaryChat:
    def test_default_is_false(self) -> None:
        assert _extract_temporary_chat({}) is False

    def test_none_config(self) -> None:
        assert _extract_temporary_chat(None) is False

    def test_true_bool(self) -> None:
        config = {"_temporary_chat": True}
        assert _extract_temporary_chat(config) is True
        assert "_temporary_chat" not in config

    def test_true_string(self) -> None:
        assert _extract_temporary_chat({"_temporary_chat": "yes"}) is True
