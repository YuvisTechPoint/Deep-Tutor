...
async def get_system_status():
    ...
    result = {
        ...
        "hidream_image": {"status": "not_configured"},
    }
    ...
    hidream_url = (os.environ.get("HIDREAM_SERVICE_URL") or "").strip()
    if hidream_url:
        result["hidream_image"] = {"status": "configured"}
