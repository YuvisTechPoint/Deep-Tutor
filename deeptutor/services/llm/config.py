...
def _set_openai_env_vars(api_key: str | None, base_url: str | None, *, source: str) -> None:
    if api_key and not _looks_like_placeholder_api_key(api_key) and not os.getenv("OPENAI_API_KEY"):
...
def _looks_like_placeholder_api_key(api_key: str | None) -> bool:
    ...
    return key in {
        ...
        "your-openai-api-key",
        "openai_api_key",
    } or "replace-me" in key or "paste-your" in key
