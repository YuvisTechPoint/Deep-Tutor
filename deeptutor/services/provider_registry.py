...
class ProviderSpec:
    ...
    keywords: tuple[str, ...]
    env_key: str
    # Extra env var names to try when ``env_key`` is unset (Google AI aliases, etc.).
...
PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    ProviderSpec(
        name="huggingface",
        keywords=("huggingface", "hf_hub", "hf-inference"),
        env_key="HF_TOKEN",
        display_name="Hugging Face",
        backend="openai_compat",
        is_gateway=True,
        detect_by_key_prefix="hf_",
        detect_by_base_keyword="router.huggingface",
