...
export interface ComposerInputHandle {
  clear: () => void;
  getValue: () => string;
  /** Replace composer text (e.g. speech-to-text) and notify parent. */
    ...
    useImperativeHandle(
      ...
      () => ({
        ...
        setValue: (value: string) => {
          ...
          setInputBoth(value);
          onInputChange(value);
          setShowAtPopup(shouldOpenAtPopup(value, pos));
      ...
      // Ref identity is stable; omit textareaRef so this array never changes length across HMR.
