...
export interface BookLibraryProps {
  ...
  /** User clicked delete on a card — parent shows confirmation UI. */
                ...
                >
                  ...
                  >
                    ...
                    <button
                      ...
                      title={t("Delete book")}
                      className="absolute right-2 top-2 rounded-md bg-white/60 p-1.5 text-[var(--muted-foreground)] opacity-0 backdrop-blur-sm transition-colors hover:bg-rose-500/10 hover:text-rose-600 group-hover:opacity-100 dark:bg-black/30 dark:hover:text-rose-400"
                    >
                      <Trash2 size={13} />
                    </button>
                  </div>
